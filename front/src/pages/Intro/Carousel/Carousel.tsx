      ...
      <div tw="mt-20 ml-40 text-3xl font-bold">
        ...
        <div tw="ml-10">
          <div tw="my-12">
            ...
            {slideState === 0 ? (
              <div tw="mt-4">
                <p tw="text-sm ml-10"> 자주 사용하는 문서를 쉽게 사용하고</p>
                <p tw="text-sm ml-10"> 업무시간을 줄여보세요</p>
              </div>
            ) : null}
          </div>
          <div tw="my-12">
            ...
            {slideState === 1 ? (
              <div tw="mt-4">
                <p tw="text-sm ml-10"> 작성 해야 하는 문서가 있나요?</p>
                <p tw="text-sm ml-10">똑똑이 알아서 필요한 내용을 입력해줘요</p>
              </div>
            ) : null}
          </div>
          <div tw="my-12">
            ...
            {slideState === 2 ? (
              <div tw="mt-4">
                <p tw="text-sm ml-10"> 제출한 문서와 제출된 문서</p>
                <p tw="text-sm ml-10"> 제출해야할 문서까지 효율적으로 관리</p>
              </div>
            ) : null}
          </div>
        </div>
