...
const IntroPage4 = () => {
  ...
  return (
    <div tw="min-w-[80rem] min-h-[42rem] flex justify-center items-center">
      <Image
        imageUrl={Knock}
        custom={tw`min-w-[32rem] max-w-[32rem] mr-[4rem]`}
      />
      <div>
        <div tw="text-5xl text-[#1E5471] font-bold mr-5 mb-20">똑똑!</div>
        <div tw="text-5xl text-[#1E5471] font-bold mr-5 mb-20">시작할까요?</div>
        <Button
          variant="secondary"
