...
public interface TemplateRepository extends JpaRepository<Template, Long> {
	...
	@Query("SELECT new b209.docdoc.server.api.template.dto.Response.TemplateNameResDTO(t.templateIdx, t.templateName) FROM Template t JOIN t.member m WHERE m.memberEmail = :memberEmail")
