...
import b209.docdoc.server.config.security.filter.GlobalFilter;
...
public class WebSecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().antMatchers("/member/sign", "/member/login", "/email/confirm", "/file/**", "/template/uuid/**");
    }
